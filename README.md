...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=askpatrickw&repository=ha-peplink-local&category=integration)
...
2. Add this repository as a custom repository in HACS:
   ...
   - Add `https://github.com/askpatrickw/ha-peplink-local` as a repository
...
1. Download the latest release from the [GitHub repository](https://github.com/askpatrickw/ha-peplink-local)
...
Contributions to improve the integration are welcome! Please feel free to submit a pull request or open an issue on the [GitHub repository](https://github.com/askpatrickw/ha-peplink-local).

## License

This project is licensed under the Apache License 2.0 - see the LICENSE file for details.

[releases-shield]: https://img.shields.io/github/release/askpatrickw/ha-peplink-local.svg?style=for-the-badge
[releases]: https://github.com/askpatrickw/ha-peplink-local/releases
[license-shield]: https://img.shields.io/github/license/askpatrickw/ha-peplink-local.svg?style=for-the-badge
